...
## 문제
$\displaystyle\int_0^{\Delta} x\,dx = \left[\frac{x^2}{2}\right]_0^{\Delta} = \frac{\Delta^2}{2}$ 이므로, 이를 대입하면 $E[x] = \frac{1}{\Delta}\cdot\frac{\Delta^2}{2} =$==빈칸== 입니다.

## 해설
1/Δ와 Δ²/2를 곱하면 Δ가 하나 약분되어 Δ/2만 남아요.
