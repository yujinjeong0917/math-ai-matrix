...
## 문제
잔차 $f_i-g_i$는 각각 $0.02,\ 0.02,\ -0.20,\ -0.02,\ -0.02$이므로, 이를 제곱해 모두 더한 잔차제곱합 $\sum_i(f_i-g_i)^2$은 ==빈칸==이다.

## 해설
각 잔차를 제곱하면 0.0004, 0.0004, 0.04, 0.0004, 0.0004이고 이를 모두 더하면 0.0416이 되기 때문이에요.
