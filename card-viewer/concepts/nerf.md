...
## 문제
이제 $T_i\alpha_i$를 전개해서 정리해본다. $T_i\alpha_i=T_i\left(1-e^{-\sigma_i\delta_i}\right)=T_i-T_ie^{-\sigma_i\delta_i}=T_i-$==빈칸== 이다.

## 해설
정의상 T_i에 e^{-σ_iδ_i}를 곱한 값이 바로 T_{i+1}과 같기 때문에, 그 항을 T_{i+1}로 바꿔 쓸 수 있어요.
