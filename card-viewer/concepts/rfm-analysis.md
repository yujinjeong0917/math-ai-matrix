...
## 해설
어떤 사업이든 고객 수가 늘면 모두를 똑같이 대하기 어려워진다. VIP 고객과 오래전에 떠난 휴면 고객에게 같은 메일을 보내는 건 자원 낭비다. RFM 분석은 복잡한 모델 없이 딱 세 가지 숫자만 본다. 최근에 샀는가(Recency), 얼마나 자주 샀는가(Frequency), 얼마나 많이 썼는가(Monetary). 이 세 축으로 점수를 매기면 누가 지금 챙겨야 할 우량 고객이고 누가 이탈 직전인지 바로 줄 세울 수 있다.

마케팅팀은 이 등급을 보고 VIP에게는 신제품을 먼저 보여주고 휴면 고객에게는 복귀 쿠폰을 보내는 식으로 대응을 나눈다.
