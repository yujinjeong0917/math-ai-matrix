...
## 문제
먼저 신규 유입에서 새로 생기는 유료 전환자 수를 구하면 $N_2 \times r_2 = 10000 \times 0.01 = $==빈칸== 명이다.

## 해설
CVR의 정의 $N_{paid}/N_{free}$를 뒤집으면 $N_{paid} = N_{free} \times \text{CVR}$이 돼요. 여기에 신규 유입 수 10,000과 전환율 0.01을 곱한 값이에요.
