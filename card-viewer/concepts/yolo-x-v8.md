...
## 문제
두 식의 차이를 구하면 $\big[2K+257(C+5)\big]-\big[K+257(5+C)\big]=K+257\big[(C+5)-(5+C)\big]$이고, 대괄호 안의 $(C+5)-(5+C)$는 $0$이므로 이 차이 전체의 값은 ==빈칸==다.

## 해설
C 항이 완전히 상쇄되고 K만 남으므로, 디커플드 헤드가 커플드 헤드보다 정확히 3×3 합성곱 한 층(K=590080)만큼만 더 무거워지고 그 차이는 클래스 수 C와 무관해요.
